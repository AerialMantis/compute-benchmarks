...
[[maybe_unused]] static const inline RegisterTestCase<SubmitRangeKernel> registerTestCase{};

class SubmitRangeKernelTest : public ::testing::TestWithParam<std::tuple<Api, bool, bool, bool, bool, size_t, size_t, bool>> {
};

TEST_P(SubmitRangeKernelTest, Test) {
    SubmitRangeKernelArguments args{};
    ...
    SubmitRangeKernel test;
    test.run(args);
}

INSTANTIATE_TEST_SUITE_P(
    SubmitRangeKernelTest,
    SubmitRangeKernelTest,
    ::testing::Combine(
