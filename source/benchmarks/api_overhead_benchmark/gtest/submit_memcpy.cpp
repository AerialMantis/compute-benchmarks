...
[[maybe_unused]] static const inline RegisterTestCase<SubmitMemcpy> registerTestCase{};

class SubmitMemcpyTest : public ::testing::TestWithParam<std::tuple<Api, bool, bool, bool, bool, size_t, size_t, bool>> {
};

TEST_P(SubmitMemcpyTest, Test) {
    SubmitMemcpyArguments args{};
    ...
    args.numCopies = std::get<5>(GetParam());
    args.copySize = std::get<6>(GetParam());
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(
        ...
        ::testing::Values(10u),           // numCopies
        ::testing::Values(1024u),         // copySize
